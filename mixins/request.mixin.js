...
module.exports = {
	methods: {
		...
		requestSuccess(name, data, login_data) {
		...
		requestError(codeError) {
			var message, code;
			console.log("Mixin Error: ", codeError)
			switch (codeError) {
				...
				//Nothing found
				case CodeTypes.NOTHING_FOUND:
					message = "Data does not exist";
					code = 200;
					break;
				// Errors on Users

				case CodeTypes.ALREADY_EXIST_EMAIL_OR_MOBILE_NUMBER:
					message = "Email id or mobile number was already registered!";
					code = 417;
					break;

				case CodeTypes.INVALID_OTP:
					message = "Invalid OTP";
					code = 417;
					break;
				...
				case CodeTypes.ALREADY_EXIST:
					message = "Given name is already exist!";
					code = 400;
					break;
			...
			return this.Promise.reject(new MoleculerError(codeError, code, "ERR_CRITIAL", {}));
		}
	}
};
